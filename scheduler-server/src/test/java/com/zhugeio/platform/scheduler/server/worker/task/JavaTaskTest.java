//package com.zhugeio.platform.scheduler.server.worker.task;
//
//import ch.qos.logback.classic.LoggerContext;
//import ch.qos.logback.classic.sift.SiftingAppender;
//import com.zhugeio.platform.scheduler.core.Constants;
//import com.zhugeio.platform.scheduler.core.enums.CommandType;
//import com.zhugeio.platform.scheduler.core.utils.*;
//import com.zhugeio.platform.scheduler.core.vo.TaskVO;
//import com.zhugeio.platform.scheduler.dal.enums.JobTypeEnum;
//import com.zhugeio.platform.scheduler.engine.task.TaskManager;
//import com.zhugeio.platform.scheduler.server.worker.logger.TaskLogDiscriminator;
...
//                LoggerUtils.buildTaskId(LoggerUtils.TASK_LOGGER_INFO_PREFIX, taskInstance.getId(),logVersion)
//        );
//        String  mainClass = "com.zhugeio.Main";
//        taskInstance.setType(JobTypeEnum.JAVA);
//        Map<String,Object> params = Maps.newHashMap();
