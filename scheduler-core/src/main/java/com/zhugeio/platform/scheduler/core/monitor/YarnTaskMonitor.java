package com.zhugeio.platform.scheduler.core.monitor;
...
import com.zhugeio.platform.scheduler.dal.po.TaskMonitor;
...
import static com.zhugeio.platform.scheduler.common.Constants.YARN_RM_HA_HOSTS;
import static com.zhugeio.platform.scheduler.common.Constants.YARN_RM_HTTP_PORT;
import static com.zhugeio.platform.scheduler.core.utils.PropertyUtils.getString;
...
public class YarnTaskMonitor {
    ...
    public void monitor(TaskVO taskVO, String yarnAppId,String remoteRmHosts,String restPort, Integer failoverCnt) throws Exception {
        ...
        remoteRmHosts = Optional.ofNullable(remoteRmHosts).orElse(PropertyUtils.getString(YARN_RM_HA_HOSTS));
        restPort = Optional.ofNullable(restPort).orElse(PropertyUtils.getString(YARN_RM_HTTP_PORT));
