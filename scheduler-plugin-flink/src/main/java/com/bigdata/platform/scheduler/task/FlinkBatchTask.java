package com.bigdata.platform.scheduler.task;

import com.bigdata.platform.scheduler.task.param.FlinkParameters;
import com.bigdata.platform.scheduler.task.param.FlinkTaskType;
import com.bigdata.platform.scheduler.core.vo.TaskVO;
import com.bigdata.platform.scheduler.spi.param.IParameters;
import com.bigdata.platform.scheduler.spi.plugin.AbstractYarnTask;
...
import static com.bigdata.platform.scheduler.common.Constants.DEFAULT_STREAMING_TASK_QUEUE;
import static com.bigdata.platform.scheduler.common.Constants.STREAMING_TASK_QUEUE_KEY;
