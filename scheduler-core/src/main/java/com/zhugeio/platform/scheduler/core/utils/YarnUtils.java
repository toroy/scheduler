...
import com.zhugeio.platform.scheduler.core.exception.MultiActiveStepException;
import com.zhugeio.platform.scheduler.core.model.AppInfo;
...
import static com.zhugeio.platform.scheduler.common.Constants.COLON;
...
public class YarnUtils {
    ...
    private static String superUser = PropertyUtils.getString(Constants.YARN_SUPER_USER);
            ...
            synchronized (YarnUtils.class) {
                if (configuration == null) {
                    try {
                        ...
                        String[] rmHaIds = PropertyUtils.getArray(YARN_RM_HA_HOSTS);
    ...
    private String getYarnAppStateRestApiTemplate(String[] rmHaHosts){
        ...
        String restPort = StringUtils.isNotBlank(PropertyUtils.getString(YARN_RM_HTTP_PORT)) ? PropertyUtils.getString(YARN_RM_HTTP_PORT) : "8088";
    ...
    private static final class YarnHAAdminUtils extends RMAdminCLI {
        ...
        public static String getActiveRMName(String[] rmIdArr) {
            int activeResourceManagerPort = PropertyUtils.getInt(YARN_RM_HTTP_PORT, 8088);
