package com.bigdata.platform.scheduler.dal.config;
...
@Configuration
@MapperScan(basePackages = "com.bigdata.platform.scheduler.dal.dao", sqlSessionFactoryRef = MybatisConfig.SQL_SESSION_FACTORY)
...
//
//        resolverUtil.find(new ResolverUtil.IsA(EnumIntegerAble.class), "com.bigdata.platform.scheduler.dal.enums");
