package com.bigdata.platform.scheduler.server.worker.task;
...
import com.bigdata.platform.scheduler.core.enums.CommandType;
import com.bigdata.platform.scheduler.core.vo.TaskVO;
import com.bigdata.platform.scheduler.dal.po.Cluster;
...
public class HiveTaskTest {
    ...
    public void before(){
        ...
        jobType.setPluginClazz("com.bigdata.platform.scheduler.engine.task.builtin.HiveTask");
