...
//import com.bigdata.platform.scheduler.core.Constants;
//import com.bigdata.platform.scheduler.core.enums.CommandType;
//import com.bigdata.platform.scheduler.core.utils.*;
...
//import com.bigdata.platform.scheduler.server.worker.logger.TaskLogDiscriminator;
...
//                LoggerUtils.buildTaskId(LoggerUtils.TASK_LOGGER_INFO_PREFIX, taskInstance.getId(),logVersion)
//        );
//        String  mainClass = "com.bigdata.Main";
//        taskInstance.setType(JobTypeEnum.JAVA);
//        Map<String,Object> params = Maps.newHashMap();
