package com.bigdata.platform.scheduler.engine.mgr;

import com.bigdata.platform.scheduler.core.utils.JSONUtils;
import com.bigdata.platform.scheduler.core.utils.NumberUtils;
...
import com.bigdata.platform.scheduler.engine.config.ExecutorConfig;
import com.bigdata.platform.scheduler.engine.dao.DataAccessFactory;
import com.bigdata.platform.scheduler.engine.runner.TaskRunner;
import com.bigdata.platform.scheduler.common.Constants;
import com.bigdata.platform.scheduler.common.utils.DateUtils;
import com.bigdata.platform.scheduler.common.utils.OSUtils;
import com.bigdata.platform.scheduler.core.dto.TaskDto;
import com.bigdata.platform.scheduler.core.enums.ZKNodeType;
import com.bigdata.platform.scheduler.core.service.ICommonService;
import com.bigdata.platform.scheduler.core.service.impl.TaskMonitorService;
import com.bigdata.platform.scheduler.core.thread.Stopper;
import com.bigdata.platform.scheduler.core.vo.MacroVarVO;
import com.bigdata.platform.scheduler.core.vo.ScriptVO;
import com.bigdata.platform.scheduler.core.vo.SlotMap;
import com.bigdata.platform.scheduler.core.vo.TaskVO;
import com.bigdata.platform.scheduler.dal.enums.JobCycleTypeEnum;
import com.bigdata.platform.scheduler.dal.enums.TaskStatusEnum;
import com.bigdata.platform.scheduler.engine.utils.AbstractZKClient;
import com.bigdata.platform.scheduler.engine.utils.TaskLock;
import com.bigdata.platform.scheduler.spi.utils.ProcessUtils;
...
import static com.bigdata.platform.scheduler.dal.enums.TaskStatusEnum.*;
...
public class TaskRunnerMgr extends AbstractZKClient {
    ...
    public void init() {
        ...
        fetchTaskExecutorService = com.bigdata.platform.scheduler.core.thread.ThreadUtils
        ...
        workerExecService = com.bigdata.platform.scheduler.core.thread.ThreadUtils
        ...
        killExecutorService = com.bigdata.platform.scheduler.core.thread.ThreadUtils
