package com.zhugeio.platform.scheduler.common.utils.placeholder;
...
public class TimePlaceholderUtils {
    ...
    private static String calculateTime(String expression, Date date, String timeZoneId) {
        ...
        String [] timeVariable = StringUtils.isNotBlank(expression) ? expression.split(Constants.TIME_EXPR_DELIMITED) : new String[0];
