package com.bigdata.platform.scheduler.common.invoker;
...
public class SafeInvoker {
    ...
    public static void invokeWithRetry(Runner runner,
        ...
        invoke(() -> Retry.doRetryRun(runner, retryTimes, sleepTimeInMilliSecond, exponential, null),
                errorHandler);
    }
    ...
    private static class Retry {
        ...
        private static void doRetryGap(int currRunTime,
            ...
            if (currRunTime + 1 < retryTimes && sleepTimeInMilliSecond > 0) {
                ...
                invoke(() -> Thread.sleep(finalTimeToSleep), (Consumer<Exception>) null);
