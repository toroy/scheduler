package com.zhugeio.platform.scheduler.server;

import com.zhugeio.platform.scheduler.server.logserver.LoggerServer;
...
import com.zhugeio.platform.scheduler.core.enums.ServerType;
import com.zhugeio.platform.scheduler.core.utils.SpringBean;
import com.zhugeio.platform.scheduler.server.leader.LeaderServer;
import com.zhugeio.platform.scheduler.server.worker.WorkerServer;

@SpringBootApplication(scanBasePackages = "com.zhugeio.platform.scheduler")
