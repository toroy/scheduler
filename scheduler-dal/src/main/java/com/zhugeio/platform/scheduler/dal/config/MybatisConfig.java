package com.zhugeio.platform.scheduler.dal.config;
...
@Configuration
@MapperScan(basePackages = "com.zhugeio.platform.scheduler.dal.dao", sqlSessionFactoryRef = MybatisConfig.SQL_SESSION_FACTORY)
...
//
//        resolverUtil.find(new ResolverUtil.IsA(EnumIntegerAble.class), "com.zhugeio.platform.scheduler.dal.enums");
