package com.zhugeio.platform.scheduler.spi.utils;
...
import static com.zhugeio.platform.scheduler.common.Constants.EXIT_CODE_KILL;
...
//    }
    ...
    public static void killYarnJob(TaskVO taskInstance) {
        try {
            ...
            long logFileSize = com.zhugeio.platform.scheduler.core.utils.FileUtils.getFileSize(taskInstance.getLogPath());
