package com.bigdata.platform.scheduler.spi.utils;
...
import static com.bigdata.platform.scheduler.common.Constants.EXIT_CODE_KILL;
...
//    }
    ...
    public static void killYarnJob(TaskVO taskInstance) {
        try {
            ...
            long logFileSize = com.bigdata.platform.scheduler.core.utils.FileUtils.getFileSize(taskInstance.getLogPath());
