package com.zhugeio.platform.scheduler.engine.mgr;

import com.zhugeio.platform.scheduler.core.utils.JSONUtils;
import com.zhugeio.platform.scheduler.core.utils.NumberUtils;
...
import com.zhugeio.platform.scheduler.engine.config.ExecutorConfig;
import com.zhugeio.platform.scheduler.engine.dao.DataAccessFactory;
import com.zhugeio.platform.scheduler.engine.runner.TaskRunner;
import com.zhugeio.platform.scheduler.common.Constants;
import com.zhugeio.platform.scheduler.common.utils.DateUtils;
import com.zhugeio.platform.scheduler.common.utils.OSUtils;
import com.zhugeio.platform.scheduler.core.dto.TaskDto;
import com.zhugeio.platform.scheduler.core.enums.ZKNodeType;
import com.zhugeio.platform.scheduler.core.service.ICommonService;
import com.zhugeio.platform.scheduler.core.service.impl.TaskMonitorService;
import com.zhugeio.platform.scheduler.core.thread.Stopper;
import com.zhugeio.platform.scheduler.core.vo.MacroVarVO;
import com.zhugeio.platform.scheduler.core.vo.ScriptVO;
import com.zhugeio.platform.scheduler.core.vo.SlotMap;
...
import com.zhugeio.platform.scheduler.engine.utils.AbstractZKClient;
import com.zhugeio.platform.scheduler.engine.utils.TaskLock;
import com.zhugeio.platform.scheduler.spi.utils.ProcessUtils;
...
import static com.zhugeio.platform.scheduler.dal.enums.TaskStatusEnum.*;
...
public class TaskRunnerMgr extends AbstractZKClient {
    ...
    public void init() {
        ...
        fetchTaskExecutorService = com.zhugeio.platform.scheduler.core.thread.ThreadUtils
        ...
        workerExecService = com.zhugeio.platform.scheduler.core.thread.ThreadUtils
        ...
        killExecutorService = com.zhugeio.platform.scheduler.core.thread.ThreadUtils
